    ...
    <Card>
      <CardHeader className={"flex flex-row items-center justify-between space-y-0 pb-2"}>
        <div className="flex-1">
          ...
          <div className="flex items-ceter gap-2 mt-1">
            {isEditing ? <div className="flex items-center gap-2">
              ...
              <Button disabled={isLoading} variant={"ghost"} size={"icon"} onClick={handleCancel}>
              ...
              : <>
                <CardDescription>
                  {
                    initialBudget ? `Rs.${currentExpenses.toFixed(2)} of Rs.${initialBudget.amount.toFixed(2)} spent` : "No budget set"
                  }
                </CardDescription>
